...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [133 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2002432, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 13660032; uint32_t buffer_offset
	}, ; 130: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13831040; uint32_t buffer_offset
	}, ; 131: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2096640, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13853600; uint32_t buffer_offset
	} ; 132: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15950240, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15950240 x i8] zeroinitializer, align 1
